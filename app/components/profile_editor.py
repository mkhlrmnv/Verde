...
def _chip_list(values: rx.Var, remove_handler) -> rx.Component:
    return rx.hstack(
        rx.foreach(
            values,
...
def _preference_group(
    ...
    return rx.vstack(
        ...
        _chip_list(values, remove_handler),
        rx.hstack(
            rx.input(
                value=new_value,
                on_change=set_value,
            ...
            rx.button("Add", on_click=add_handler, variant="soft"),
            width="100%",
        ),
        rx.foreach(
            values,
    ...
    return rx.card(
        rx.vstack(
            rx.hstack(
                ...
                rx.button("Add", on_click=AppState.add_empty_experience, variant="soft", size="2"),
                justify="between",
                width="100%",
            ),
            rx.foreach(
            ...
            rx.card(
                rx.vstack(
                    rx.text("Quick Add", size="2", weight="medium", color_scheme="gray"),
                    rx.input(
    ...
    return rx.card(
        rx.vstack(
            rx.hstack(
                ...
                rx.button("Add", on_click=AppState.add_empty_project, variant="soft", size="2"),
                justify="between",
                width="100%",
            ),
            rx.foreach(
    ...
    return rx.card(
        rx.vstack(
            ...
            rx.hstack(
                ...
                rx.button("Add", on_click=AppState.add_skill, variant="soft"),
                width="100%",
            ),
            spacing="2",
            align_items="stretch",
    ...
    return rx.card(
        rx.vstack(
            rx.hstack(
                ...
                rx.button("Add", on_click=AppState.add_language, variant="soft", size="2"),
                justify="between",
                width="100%",
            ),
            rx.foreach(
    ...
    return rx.vstack(
        rx.hstack(
            rx.vstack(
                ...
                rx.text("Review and edit your extracted information.", color_scheme="gray"),
                spacing="1",
                align_items="start",
            ),
